# a2-Create-Team.ps1
# Azure Automation Account script to create a ew Team with credentials of a user.
...
Add-TeamUser -GroupId $group.GroupId -Owner "admin@tpe5.OnMicrosoft.com"
Write-Output "$(Get-Date) team $($teamname) owners added."

Add-TeamUser -GroupId $group.GroupId -User $owner
Add-TeamUser -GroupId $group.GroupId -User "AlexW@tpe5.OnMicrosoft.com"
Add-TeamUser -GroupId $group.GroupId -User "AdeleV@tpe5.OnMicrosoft.com"
Add-TeamUser -GroupId $group.GroupId -User "martina@tpe5.OnMicrosoft.com"
